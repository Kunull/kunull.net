...
*/}
				...
				<p className='spacing'>
					<span className="personal">IN MY FREE TIME I SOLVE AND CREATE </span>
					<Button 
						button="" 
					...
					/>
					<span className="personal"> FOR CTFS AND BOOT2ROOT MACHINES. I ALSO SHARE MY LEARNINGS AND EXPERIENCES ON MY </span>
					<Button 
						button="" 
